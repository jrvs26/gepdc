    ...
    return (
        <header
            ...
            <section className='flex flex-col lg:items-center lg:justify-center gap-4 py-3 sm:px-10 px-4 border-gray-200 border-b min-h-[75px]'>
                <a href="/gepdc/home" className="shrink-0">
                ...
                <div id="collapseMenu" className={`lg:!block ${isMenuOpen ? 'block' : 'hidden'}`}>
                    ...
                    <ul className={`lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-full
                        ...
                        <li className='group max-lg:border-b max-lg:px-3 max-lg:py-3 relative'>
                            <a href='/gepdc/about' className='hover:text-green-500 text-gray-700 font-semibold text-[15px] block'>
                                About
                            ...
                            <ul className='absolute top-5 max-lg:top-8 left-0 z-50 rounded-xl block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[200px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                                <li className='border-b pb-2'>
                                    <a href='/gepdc/about' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>About Our Company</a>
                                </li>
                                <li className='border-b py-3'>
                                    <a href='##' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Our Teams</a>
                                </li>
                                <li className='pt-2'>
                                    <a href='##' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Careers</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='group max-lg:border-b max-lg:px-3 max-lg:py-3 relative'>
                            <a href='/gepdc/projects' className='hover:text-green-500 text-gray-700 font-semibold text-[15px] block'>
                                Projects
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" className="ml-1 inline-block" viewBox="0 0 24 24">
                                    <path d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z" />
                                </svg>
                            ...
                            <ul className='absolute top-5 max-lg:top-8 left-0 z-50 block rounded-xl space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[260px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                                <li className='border-b pb-2'>
                                    <a href='/gepdc/projects/giga8' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>GIGA 8 Project</a>
                                </li>
                                <li className='border-b py-3'>
                                    <a href='/gepdc/projects/sspc' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>SSPC Project</a>
                                </li>
                                <li className='border-b py-3'>
                                    <a href='/gepdc/projects/dspp' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>DSPP Project</a>
                                </li>
                                <li className='pt-2'>
                                    <a href='/gepdc/projects/tera3' className='text-gray-400 font-semibold text-[15px] block cursor-not-allowed' aria-disabled='true'>
                                        TERA 3 Project
                        ...
                        <li className='group max-lg:border-b max-lg:px-3 max-lg:py-3 relative'>
                            ...
                            <ul className='absolute top-5 max-lg:top-8 left-0 z-50 block rounded-xl space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[250px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                                <li className='border-b pb-2'>
                                    <a href='/gepdc/services/solar-plant' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Solar Power Plant</a>
                                </li>
                                <li className='border-b py-3'>
                                    <a href='/gepdc/services/thermal-scanning' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Thermal Scanning</a>
                                </li>
                                <li className='border-b py-3'>
                                    <a href='/gepdc/services/power-system' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Power Systems</a>
                                </li>
                                <li className='pt-2'>
                                    <a href='/gepdc/services/electrical-testing' className='hover:text-green-500 text-gray-600 font-semibold text-[15px] block'>Electrical Testing</a>
                                </li>
                            </ul>
                        </li>
                        <li className='max-lg:border-b max-lg:px-3 max-lg:py-3'>
                            <a href='/gepdc/clients' className='hover:text-green-500 text-gray-700 font-semibold text-[15px] block'>
                                Clients
                            </a>
                        </li>
                        {/* Contact Section */}
                        <li className='max-lg:border-b max-lg:px-3 max-lg:py-3'>
                            <a href='/gepdc/contact' className='hover:text-green-500 text-gray-700 font-semibold text-[15px] block'>
                                Contact
                            </a>
                        </li>
                    </ul>
