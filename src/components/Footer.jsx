...
function Footer() {
    return (
        <footer className="bg-gray-300/40 shadow-xl font-sans dark:bg-gray-900">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-y-2 lg:grid-cols-4">
                    ...
                    <div className='mt-28'>
                        ...
                        <div className="flex flex-col items-start mt-5 space-y-2 sm:text-center">
                            <Link to="/home"> <p className="text-black font-medium transition-colors duration-300 dark:text-gray-300 dark:hover:text-green-400 hover:cursor-pointer hover:text-green-500">Home</p></Link>
                            <Link to="/projects"><p className="text-black font-medium transition-colors duration-300 dark:text-gray-300 dark:hover:text-green-400 hover:cursor-pointer hover:text-green-500">Our Projects</p></Link>
                            <Link to="/services"><p className="text-black font-medium transition-colors duration-300 dark:text-gray-300 dark:hover:text-green-400 hover:cursor-pointer hover:text-green-500">Our Services</p></Link>
                    ...
                    <div className='mt-28'>
                        ...
                        <div className="flex flex-col items-start mt-5 space-y-2">
                            <Link to="/about"><p className="text-black font-medium transition-colors duration-300 dark:text-gray-300 dark:hover:text-green-400 hover:cursor-pointer hover:text-green-500">About Us</p></Link>
